...
<form action="/ProjectManagementTool/editingregion" method="POST">
<table border="0" width="70%" bgcolor="#f0f0f5">
	...
	<tr height="50px;">
		<td width="300px;"></td>
		<td align="left"  width="150px;">Region Id</td>
	    <td align="left"> <input type="text" name="id" value="${region.id}" readonly="readonly"> </td>	    			
	</tr>
	<tr height="50px;">
		<td width="300px;"></td>
		<td align="left"  width="150px;">Region Name</td>
	    <td align="left"> <input type="text" name="name" value="${region.name}"> </td>	    			
	</tr>
	<tr height="50px;">
		<td width="300px;"></td>
		<td align="left" width="150px;">Region Description</td>
	    <td align="left"><input type="text" name="description" value="${region.description}"></td>	    			
	</tr>
	<tr height="50px;">
		<td width="300px;"></td>
