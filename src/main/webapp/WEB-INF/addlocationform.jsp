...
<form action="/ProjectManagementTool/addinglocation" method="post">
<table border="0" width="70%" bgcolor="#f0f0f5">
	...
	<tr height="50px;">
	    ...
	    <td align="left"><input type="text" size=50 name="state"> </td>	    			
	</tr>
	<tr height="50px;">
		<td width="300px;"></td>
		<td align="left" width="150px;">City</td>
	    <td align="left"><input type="text" size=15 name="city"></td>	    			
	</tr>	
	<tr height="50px;">
		<td width="300px;"></td>
