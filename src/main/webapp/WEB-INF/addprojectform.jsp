...
<html>
<head>
<link href="<c:url value="/resources/styles/addprojectform.css" />" rel="stylesheet">
...
<form action="/ProjectManagementTool/addingproject" method="post">
<table>	
	<tr>
	<td>Project Name</td>
	<td>
	...
	<tr>
	<td>Description</td> <td><input type="text" name="desc"></input></td>
	</tr>
	...
	<tr>
	<td>Start Date</td> <td><input type="date" name="psd"></input></td>
	</tr>
	
	<tr>
	<td>End Date</td> <td><input type="date" name="ped"></input></td>
	</tr>
